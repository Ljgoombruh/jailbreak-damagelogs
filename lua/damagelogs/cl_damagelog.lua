...
include("damagelogs/not_my_code/coloredbox.lua")
include("damagelogs/not_my_code/util.lua")
...
function Damagelog:OpenMenu()
	...
	self.Menu:SetTitle("Jailbreak Damagelogs version "..self.VERSION) 
	...
	self.Menu.PaintOver = function(self, w, h)
      ...
      surface.SetTextPos(_x + 5, _y  + 40)
			...
			surface.SetTextPos(_x + 5, _y  + 100)
